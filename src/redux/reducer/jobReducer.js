...
const jobSlice = createSlice({
  ...
  reducers: {
    ...
    getJobofComapnySuccess: (state, action) => {
      state.loading = false;
      // If API returns {job, applications}, store both
      if (action.payload && action.payload.applications && action.payload.job) {
        state.applicationOfJob = action.payload.applications;
